...
class TabGrill extends Component {
	static navigationOptions = ({ navigation }) => {
		console.log('grill: ', navigation);
		console.log(navigation.state.params.product.item.typePreparation);
		return {
	...
	render() {
		...
		// console.log(product);
		const titleMeat = product.item.name;
...
class TabOven extends Component {
	static navigationOptions = {
		tabBarLabel: 'Horno',
		tabBarIcon: ({ tintColor }) => (
			<Image
				source={require('../assets/levels/oven.png')}
				style={{ height: 25, width: 25, tintColor: tintColor }}
			/>
		),
	};
...
const Detail1Screen = createBottomTabNavigator(
	{
		Grill: TabGrill,
		Oven: TabOven,
	},
...
export default createAppContainer(Detail1Screen);
